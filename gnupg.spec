...
Version  : 2.1.18
Release  : 19
URL      : ftp://ftp.gnupg.org/gcrypt/gnupg/gnupg-2.1.18.tar.bz2
Source0  : ftp://ftp.gnupg.org/gcrypt/gnupg/gnupg-2.1.18.tar.bz2
Source99 : ftp://ftp.gnupg.org/gcrypt/gnupg/gnupg-2.1.18.tar.bz2.sig
Summary  : zlib compression library
Group    : Development/Tools
License  : BSD-3-Clause CC0-1.0 GPL-3.0 LGPL-3.0
Requires: gnupg-bin
Requires: gnupg-doc
Requires: gnupg-data
...
%prep
%setup -q -n gnupg-2.1.18
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485220388
